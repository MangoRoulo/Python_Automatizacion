...
# Funciones
    ...
    def inicioSesion(self, usuario=usuario, clave=clave):
        ...
        self.driver.find_element(By.XPATH, "//input[@name='email']").send_keys(str(usuario))
        self.driver.implicitly_wait(20)
        self.driver.find_element(By.NAME, "pass").send_keys(clave)
